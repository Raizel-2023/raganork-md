...
module.exports = {
    ...
    AUTOMUTE_MSG: process.env.AUTOMUTE_MSG || '_القرو انقفل!_\n_(Change this by setting var AUTOMUTE_MSG)_',
    ANTI_SPAM: process.env.ANTI_SPAM || '967770500831-967770500831@g.us',
    ANTISPAM_COUNT: process.env.ANTISPAM_COUNT || '7/10',
    AUTOUNMUTE_MSG: process.env.AUTOUNMUTE_MSG || '_قروب انفتحد!_\n_(Change this by setting var AUTOUNMUTE_MSG)_',
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://telegra.ph/file/39272916fd98efa5fec86.jpg.jpeg;://chat.whatsapp.com/CMp1e9NHmHU5K5sCM2mmKn',
